...
import { getPendingVaccinations, sendNotification, confirmVaccination } from "../../api/vaccine";
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content shadow-lg">
                            ...
                            <div className="modal-body">
                                <p>Bạn có chắc chắn muốn gửi thông báo cho học sinh: <strong>{selectedUser.fullName}</strong>?</p>
                            </div>
